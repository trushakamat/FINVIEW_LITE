...
A lightweight Flutter app for viewing financial data. Replace placeholders below with project-specific links, screenshots and notes.
...
- Demo (screen recording): https://example.com/your-demo-link
(Use Google Drive, Dropbox or a short public URL)
...
```// filepath: c:\Users\trush\OneDrive\Desktop\Flutter project\finview_lite\README.md
